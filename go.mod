module github.com/oaago/server
...
require (
	...
	github.com/oaago/cloud v0.3.1
	github.com/oaago/gateway v0.0.0-20220619130458-82cc121d4b1b
...
require (
	...
	github.com/oaago/common v0.0.0-20220719142924-e8a703801734 // indirect
